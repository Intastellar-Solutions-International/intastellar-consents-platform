            ...
            <div className="navOverlay">
                <aside className="sidebar">
                    <nav className="collapsed">
                        ...
                        <Link className={"navItems" + (useLocation().pathname.indexOf("/compare") > -1 ? " --active" : "")} to={"/" + localStorage.getItem("platform") + "/reports/compare"}><i className="dashboard-icons compare"></i> <span className="hiddenCollapsed">Compare</span></Link>
